...
Наиболее распространенной в мире является серия 7400 ТТЛ микросхем компании Texas Instruments. Отечественным аналогом которой является серия К555. Поскольку ТЗ не предъявляет требований к выбору серии, а также ввиду распространенности компонентной базы на основе 7400, принято решение использовать микросхемы К555, а также К155 (для микросхем, не входящих в серию К555), подбор МС осуществлялся согласно справочнику @справочник-компонентов. 
...
Микросхема К155ЛЛ1 (показана на рисунке @к155лл1) представляет собой четыре логических элемента 2ИЛИ. Информационными входами являются пары выводов: 1 и 2, 4 и 5, 9 и 10, 12 и 13. Информационными выходами являются выводы 3, 6, 8, 11.

#рис(image("../уго/К155ЛЛ1.png", height: 20%))[ УГО К155ЛЛ1 ] <к155лл1>

Микросхема К155ЛИ1 (показана на рисунке @к155ли1) представляет собой четыре логических элемента 2И. Информационными входами являются пары выводов: 1 и 2, 4 и 5, 9 и 10, 12 и 13. Информационными выходами являются выводы 3, 6, 8, 11.
