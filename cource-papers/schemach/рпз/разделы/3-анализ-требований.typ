...
Блок ввода входных сигналов реализует механизм передачи сигналов управления на схему. Блок вывода состояния игры реализует интерфейс вывода сигналов состояния с устройства.
