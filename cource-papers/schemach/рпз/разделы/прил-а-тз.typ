...
#страница(image("../материалы/ТЗ_титул.jpg", height: 100%), номер: нет)
...
5.1 Устройство должно обрабатывать управляющие сигналы, на основе которых обновлять внутреннее состояние и выходные сигналы, включающие в себя позицию колеса, бит остановки колеса, для каждого из трех игроков счет игрока и бит выбранности и бит активности игрока.

5.2 Логика элементов – ТТЛ.

К разрабатываемому устройству предъявляются условия
эксплуатации в соответствие с СанПиН2.2.2/2.4.1340-03.
Требования к маркировке и упаковке разрабатываемого устройства
не предъявляются.

Требования к транспортированию и хранению разрабатываемого устройства не предъявляются.
