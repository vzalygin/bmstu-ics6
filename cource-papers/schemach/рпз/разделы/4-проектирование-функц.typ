...
Фиксация значения на счетчике происходит при помощи подачи асинхроного сигнала P0 со стороны пользователя. Отследить значение счетчика со стороны пользователя не представляется возможным, за счет чего достигается эффект случайности значения. 
