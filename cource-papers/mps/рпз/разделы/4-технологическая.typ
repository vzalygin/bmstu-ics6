...
#рис(image("../материалы/mps-Схема алгоритмов Сказать.drawio.png", width: 60%))[ Схема алгоритма основной функции генерации речи ] <say>
...
== Портирование SAM под МК ATMega128A
...
#рис(image("../материалы/mps-Схема алгоритмов SAM.drawio.png"))[ Схема алгоритма синтеза речи SAM ] <sam>
...
#рис(image("../материалы/mps-Схема алгоритмов Транслятор.drawio.png", width: 55%))[ Схема алгоритмов модуля трансляции ] <транслятор>
