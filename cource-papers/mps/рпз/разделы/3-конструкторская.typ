...
$
  P_"sum" = sum_i P_i = sum_i I_i * U_"питания" + P_"RC" = \ = (10 + 0.08 + 10 + 3.5 + 20) "мА" * 5 "B" + 25 "мВт" approx 70 "мВт",
$ <сумм-мощн>
#v(-1.5em)
где $P_"sum"$ -- суммарная мощность всего устройства,\
$P_i$ -- мощность i-го устройства.

Таким образом суммарная мощность устройства составляет $P_"sum" approx 70 "мВт"$.
