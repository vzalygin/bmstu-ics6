...
В рамках курсовой работы разработано устройство синтеза речи на основе TTS программы SAM для русского и английского языков на основе микроконтроллера ATMega128A. Устройство может быть подключено и использовано при помощи протокола UART.
