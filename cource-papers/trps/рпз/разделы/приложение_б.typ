...
#страница(image("../материалы/рукво титул.jpg", height: 100%), номер: нет, содержимое: [#context counter(page).update(1)])
...
Листинг @факт содержит программу вычисления факториала.
