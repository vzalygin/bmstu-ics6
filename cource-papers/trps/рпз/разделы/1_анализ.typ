...
На основе диаграммы вариантов использования можно составить ключевые сценарии использования. В таблице @вариант-использования1 содержится информация о взаимодействии программиста с системой при генерации исполняемого файла с учетом ошибок, которые программист может допустить в программе.
...
В соответствии с техническим заданием (приложение А) программное решение должно обеспечивать создание различных выходных файлов.
