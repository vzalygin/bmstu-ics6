...
== Разработка синтаксических диаграмм исходного языка

Выбранная библиотека для построения генераторов комбинаторных парсеров, Nom, позволяет реализовать разбор выражений методов рекурсивного спуска. Также по техническому заданию необходимо реализовать разбор ряда конструкций в синтаксисе обратной польской записи. В связи с данными ограничениями аксиома языка описывает подходящий под требования конкатенативный язык. Аксиома изображена на рисунке @аксиома.

#рис(image(
  "../материалы/курсач_трпс-1 Синтаксическая диаграмма.drawio.png"
))[ Синтаксическая диаграмма аксиомы исходного языка ] <аксиома>

Одним из самых главных правил в грамматике является правило "терм", обозначающее некоторую операцию. Рисунок @терм показывает синтаксическую диаграмму правила "терм".

#рис(image(
  "../материалы/курсач_трпс-2 Синтаксическая диаграмма.drawio.png"
))[ Синтаксическая диаграмма "терм" ] <терм>

Между термами могут располагаться разделители, в том числе и комментарии. Синтаксическая диаграмма правил "разделитель" и "комментарий" показана на рисунке @разделитель.

Остальные правила изображены на рисунках @число, @термы, @список.
...
== Разработка РБНФ интерфейса командной строки

Поскольку приложение должно иметь интерфейс командной строки, целесообразно разработать грамматику интерфейса. В качестве формы представления грамматики удобно использовать расширенную форму Бекуса-Наура, так как она позволяет емко и понятно показать грамматику. Форма изображена на рисунке @рбнф.

#рис(image(
  "../материалы/курсач_трпс-ОК РБНФ.drawio.png"
