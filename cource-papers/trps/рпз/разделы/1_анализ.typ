...
Отношения расширения определены за счет того, что расширяемый вариант использования является частью расширяющего варианта использования, но с дополнительными действиями. Так, создание объектного файла включает в себя создание ассемблерного листинга, который затем ассемблируется в объектный файл. Создание исполняемого файла включает в себя создание объектного файла, который затем компонуется с стандартной библиотекой в исполняемый файл.
...
Наконец критерий "современные методы разработки" учитывает поддержку языком принятых в профессиональном сообществе стандартов написания кода и программых продуктов. Так, например, язык Си не поддерживает концепцию generic objects, в то время, как это делают все остальные указанные языки.
