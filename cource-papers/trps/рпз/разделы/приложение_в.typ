...
#show: приложение.with(буква: "В", содержание: [ ПРИЛОЖЕНИЕ В. Фрагмент кода ])
...
#страница(image("../материалы/титул_фрагмент.svg"), номер: нет, содержимое: [#context counter(page).update(1)])
