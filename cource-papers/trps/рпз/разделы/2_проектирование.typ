...
Согласно подразделу @анал-задания в рамках разработки был выбран структурный подход. Для работы при таком подходе необходимо уточнить структурную схему программного решения. На рисунке @структурная-схема изображена структура проекта.
...
- программа-компилятор, часть, агрегирующая все модули программы, является точкой входая при запуске программы;
...
#рис(image(
  "../материалы/курсач_трпс-ОК РБНФ.drawio.png", width: 115%
