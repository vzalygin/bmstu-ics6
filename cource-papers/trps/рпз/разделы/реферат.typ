...
#let рисунки = context counter(figure).final().at(0)
#let таблицы = 0
#let источники = 0
#let приложения = 2
...
Разрабатываемое программное обеспечение предназначенно для программистов, создающих программы на исходном языке.
