...
Настоящее техническое задание распространяется на разработку программы "Компилятор стекового языка программирования", используемой для трансляции в байткод Wasm и верификации программ и предназначенной для создания исполняемых файлов по текстам программ, написанных программистом на конкатенативном стековом языке программирования Cat.
...
4.3.5 Разработка структуры программного обеспечения и его компонентов.

4.3.6 Проектирование программных компонентов: парсера, статического анализатора, кодогенератора.
