...
Рантайм -- (англ. runtime, время исполнения) термин, имеющий несколько значений: время исполнения программы; окружение программы, в котором она исполняется
...
.NET CIL -- .NET Common Intermediate Language, промежуточный язык (байт-код) платформы .NET, в который транслируются программы и который исполняется средой выполнения (CLR) или преобразуется в машинный код
