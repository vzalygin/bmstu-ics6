...
#таблица(table(
  ...
  text(size: 10pt)[Трнсляция управляющих конструкций в примитивные переходы и последовательности слов, уменьшая накладные расходы управления.],

  text(size: 10pt)[Переписывание и специализация без побочных эффектов (Joy)],
  text(size: 10pt)[Конкатенация цитат, перестановка инструкций с сохранением формы и размера стека с точки зрения внешнего наблюдателя],
  ...
  text(size: 10pt)[Stack caching (общая техника)],
  text(size: 10pt)[Кэширование верхних элементов стека в регистрах, уменьшение обращений к памяти и обновлений указателя стека.],

  text(size: 10pt)[Динамические суперинструкции (общая техника)],
  text(size: 10pt)[Объединение частых последовательностей инструкций в одну “суперинструкцию” для уменьшения диспетчеризации.],
