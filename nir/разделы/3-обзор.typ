...
Синтаксис Forth основан на обратной польской нотации: программа представляет собой последовательность слов, разделённых пробелами. Интерпретатор последовательно читает лексемы, ищет их в словаре и либо выполняет связанный код, либо интерпретирует лексему как число и помещает его на стек. Определения новых слов задаются конструкцией вида ": NAME ... ;", при этом большинство лексем — от переменных до управляющих конструкций — оформляются как слова. Грамматика языка показана в листинге 1.
