...
Байткод Wasm в основном поставляется в виде бинарного представления, которое при необходимости может быть транслировано в текстовое человеко-читаемое представление. Текстовый вариант основан на записи S-выражений @wasm-syntax, что отличает этот язык от рассмотренных ранее. Листинг @wasm-example демонстрирует определение функции сложения числа с самим собой в человеко-читаемом виде.
