...
4.1.1.2 Typing Functional StackUBased Languages [Электронный ресурс]. URL: https://dcreager.net/remarkable/Diggins2008b.pdf (дата обращения: 13.10.2025).

4.1.1.3 Cat  language  repository  [Электронный  ресурс].  URL:  https://github.com/cdiggins/catlanguage (дата обращения: 13.10.2025).

4.1.1.4 WebAssembly  Specification  1.0  [Электронный  ресурс].  URL:
https://webassembly.github.io/spec/versions/core/WebAssemblyU1.0.pdf  (дата  обращения: 11.11.2025).

4.1.1.5 Understanding WebAssembly text format [Электронный ресурс]. URL:
https://developer.mozilla.org/enUUS/docs/WebAssembly/Guides/Understanding_
the_text_format (дата обращения: 11.11.2025).

4.2 Цель работы

Целью работы является прототип компилятора стекового языка программирования.

4.3 Решаемые задачи

4.3.1 Анализ синтаксиса, семантики, а также описанных средств статического анализа языка программирования Cat.

4.3.2 Анализ устройства байткода и модели исполнения WebAssembly.

4.3.3 Выбор архитектуры, подхода, методов, технологии и средств разработки для программного обеспечения (далее ПО).

4.3.4 Анализ требований технического задания (далее ТЗ) с точки зрения выбранной технологии и уточнение требований к ПО -- уточнение функциональных и нефункциональных требований, требований к интерфейсам, надежности и безопасности.
...
4.3.8 Реализация компонентов ПО.

4.3.9 Проведение комплексного тестирования ПО.
...
5.2.1 Предусмотреть контроль синтаксической корректности текста на исходном языке.

5.2.2 Предусмотреть контроль корректности работы программ с стеком данных.

5.2.3 Предусмотреть контроль консистентности флагов, передаваемых при вызове программы.
...
5.4.2 Минимальная конфигурация технических средств, на которых может быть запущен компилятор:
...
ПО должно иметь интерфейс командной строки.
...
6.3.4 Синтаксическая диаграмма грамматики исходного языка.
