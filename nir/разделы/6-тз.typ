...
Настоящее техническое задание распространяется на разработку программы "Компилятор стекового языка программирования" [КСЯП], используемой для трансляции в байткод Wasm и верификации программ и предназначенной для создания исполняемых файлов по текстам программ, написанных программистом на конкатенативном языке программирования.
...
Основное назначение компилятора заключается в преобразовании (трансляции) программ, написанных на исходном языке в байткод, описанный спецификацией виртуальной машины WebAssembly. Также компилятор может осуществлять верификацию программы при помощи статического анализа.
...
4.1.3 WebAssembly  Specification  1.0  [Электронный  ресурс].  URL:
https://webassembly.github.io/spec/versions/core/WebAssemblyU1.0.pdf  (дата  обращения: 11.11.2025).

4.1.4 Understanding WebAssembly text format [Электронный ресурс]. URL:
...
Исходные данные должны быть представлены в виде текста программы на исходном языке и управляющими флагами, указывающими на тип проводимого действия (генерация байткода и/или верификация).
...
6.3.2 Результаты сравнительного анализа стековых языков.

6.3.3 Схемы алгоритмов.

6.3.4 Функциональная диаграмма ПО.

// 6.3.5 Диаграмма вариантов использования.

6.3.5 Диаграмма компоновки программных компонентов.
...
1 Постановочный лист
2 граф часть про НИР
3-6 Конструкторская часть листы
