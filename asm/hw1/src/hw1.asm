...
cycle1: ; внешний цикл. обход всех элементов
	...
	; cmp		ecx, 0			; если длинна равна нулю
	; je		sk				; то поиск пропускаем (иначе поломается), элемента нет
...
print_char_info: ; выводим информацию о количестве вхождений символа
	...
	rep movsb				
	; вывод буфера
	add		rax, 3			; 3 символа еще занимает начало буфера
	...
	cmp		rdx, 0			; равняется ли rdx нулю
